...
```{figure} ./ish.png
:label: ishgantt
:alt: Gant-Chart fürISH Algorithmus
:align: center

Ablauf für den ISH-Algorithmus für den in [Abbildung %s](#DAG) dargestellten Task-Graphen.
```
...
```{figure} ./mcp.png
:label: mcpgantt
:alt: Gant-Chart für MCP Algorithmus
:align: center

Ablauf für den MCP-Algorithmus für den in [Abbildung %s](#DAG) dargestellten Task-Graphen.
```
...
Ablauf für den ETF-Algorithmus für den in [Abbildung %s](#DAG) dargestellten Task-Graphen.
```
